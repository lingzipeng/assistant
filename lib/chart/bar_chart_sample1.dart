          ...
          child: Row(
            ...
            children: [
              TextButton(
                ...
                child: Text("语文18",style: TextStyle(color: Colors.white)),
              ),
              TextButton(
                onPressed: () {  },
                style: ButtonStyle(
                ...
                child: Text("数学17",style: TextStyle(color: Colors.white)),
              ),
              TextButton(
                onPressed: () {  },
                style: ButtonStyle(
                ...
                child: Text("英语10",style: TextStyle(color: Colors.white)),
              ),
              TextButton(
                onPressed: () {  },
                style: ButtonStyle(
                ...
                child: Text("总分2.5",style: TextStyle(color: Colors.white)),
              ),
            ],
          ),
        ),
